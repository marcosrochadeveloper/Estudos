...
Sua opção: '''))
if opcao == 1:
    print(f'{inteiro} convertido para BINÁRIO é {bin(inteiro)[2:]}')
elif opcao == 2:
    print(f'{inteiro} convertido para OCTAL é {oct(inteiro)[2:]}')
elif opcao == 3:
    print(f'{inteiro} convertido para HEXADECIMAL é {hex(inteiro)[2:]}')
else:
